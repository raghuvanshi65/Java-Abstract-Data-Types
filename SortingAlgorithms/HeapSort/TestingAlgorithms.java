...
public class TestingAlgorithms {
    public static void main(String[] args) throws Exception{
        ...
        System.out.println(Arrays.toString(sorter.createHeapFromArray(new Integer[] { 2, 3, 7, 1, 5, 4, 9, 4 })));
        ...
        System.out.println(Arrays.toString(sortArray.getArraySorted(new Integer[] { 2, 3, 7, 1, 5, 4, 9, 4 })));
